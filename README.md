...
- 🚀 **Backend** — REST APIs, microservices, and dynamic backend architectures
- 🎨 **Frontend** — Responsive interfaces and interactive designs
...
Open to collaboration, freelance projects, and interesting conversations about backend architecture.
